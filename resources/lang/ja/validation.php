...
return [
    ...
    */
    ...
    'filled'               => '値を入力してください',
    'gt'                   => [
        'numeric' => ':valueより大きい必要があります。',
        'file'    => ':valueキロバイトより大きい必要があります。',
        'string'  => ':value文字より多い必要があります。',
        'array'   => ':value個より多くの項目が必要です。',
    ],
    'gte'                  => [
    ...
    'lt'                   => [
        'numeric' => ':value未満である必要があります。',
        'file'    => ':valueキロバイト未満である必要があります。',
        'string'  => ':value文字未満である必要があります。',
        'array'   => ':value未満の項目を持つ必要があります。',
    ],
    'lte'                  => [
        'numeric' => ':value以下である必要があります。',
        'file'    => ':valueキロバイト以下である必要があります。',
        'string'  => ':value文字以下である必要があります。',
        'array'   => ':value以上の項目を持つ必要があります。',
    ],
    'max'                  => [
        'numeric' => ':max以下のみ有効です',
        'file'    => ':maxKB以下のファイルのみ有効です',
        'string'  => ':max文字以下のみ有効です',
        'array'   => ':max個以下のみ有効です',
    ],
    'mimes'                => ':valuesタイプのみ有効です',
    'mimetypes'            => ':valuesタイプのみ有効です',
    'min'                  => [
        'numeric' => ':min以上のみ有効です',
        'file'    => ':minKB以上のファイルのみ有効です',
        'string'  => ':min文字以上のみ有効です',
        'array'   => ':min個以上のみ有効です',
    ],
